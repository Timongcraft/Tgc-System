# Tgc-System
   **Information**
- **There won't be a SRC unless I decide it so don't ask for it!**
...
- Join message (toggle, message)
- Status on join (toggle)
- ChatPing sound (toggle, excluded player list)
- Timestamp in chat (toggle)
