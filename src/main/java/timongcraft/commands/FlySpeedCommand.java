    ...
    private static class FlySpeedExecutor implements CommandExecutor {
        ...
        public void run(CommandSender sender, CommandArguments args) throws WrapperCommandSyntaxException {
            if(args.args().length == 0) {
                ...
                TeamUtils.sendToTeam(player.getName(), null, false, "Reset his fly speed");
                ...
                TeamUtils.sendToTeam(player.getName(), null, false, "Set his fly speed to " + args.get("flyspeed"));
                ...
                TeamUtils.sendToTeam(sender.getName(), target.getName(), true, "Set the fly speed of " + target.getName() + " to " + args.get("flyspeed"));
            }
